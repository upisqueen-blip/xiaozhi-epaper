# 小智 ESP32-S3 双屏电子纸智能终端

（中文 | [English](README.md) | [日本語](README_ja.md)）

## 项目概述

本项目是一款基于 ESP32-S3 自主设计的一体化双屏电子纸智能终端。主板可独立驱动
A、B 两块 24Pin 电子纸屏；搭配 24Pin 转 50Pin 扩展板，还可驱动 7 英寸 E Ink
E6 电子纸屏。

固件将电子纸信息展示、语音交互、本地媒体存储和智能家居控制整合到同一设备中，
...
- 信息应用：相册、日历、课程表、便签、Token 余额看板
- 电子书阅读：适用于支持快速刷新的电子纸屏
- 图片管理：支持远程下发图片，以及从 TF/microSD 卡读取并播放本地图片
- 语音能力：支持小智语音交互和音频录制
- 智能家居：可连接本地 Home Assistant，实现局域网内物联网设备控制

> 电子书体验取决于屏幕刷新速度及波形支持情况；不同屏幕与转接板组合应以实板
> 测试结果为准。
